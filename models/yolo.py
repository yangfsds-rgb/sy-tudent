...
from models.DySample import *

from models.BiFormer import *
from models.SEAttention import *
...
class Detect(nn.Module):
    ...
    def __init__(self, nc=3, ch=(), inplace=True):  # detection layer
        super().__init__()
...
class DetectionModel(BaseModel):
    ...
    def __init__(self, cfg='./yolov9-s.yaml', ch=3, nc=3, anchors=None):  # model, input channels, number of classes
        super().__init__()
...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in {
            ...
            ELAN1, RepNCSPELAN4, SPPELAN,SCConv,RepNCSPELAN4SCConv1,GroupBatchnorm2d,GhostConv}:
            c1, c2 = ch[f], args[0]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='C:/Users/86150/Desktop/yolov9-main1/yolov9-main/models/detect/yolov9-s.yaml', help='model.yaml')
