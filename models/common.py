...
class Detections:
    ...
    def save(self, labels=True, save_dir='runs/detect/yolov9s2', exist_ok=False):
        save_dir = increment_path(save_dir, exist_ok, mkdir=True)  # increment save_dir
        self._run(save=True, labels=labels, save_dir=save_dir)  # save results

    def crop(self, save=True, save_dir='runs/detect/yolov9s2', exist_ok=False):
...
class RepNCSPELAN4SCConv1(RepNCSPELAN4):
    ...
    def __init__(self, c1, c2, c3, c4, c5=1):  # ch_in, ch_out, number, shortcut, groups, expansion
        ...
        self.cv2 = nn.Sequential(RepNCSP_SCConv(c3 // 2, c4, c5),  GhostConv(c4,c4,3,1))
        self.cv3 = nn.Sequential(RepNCSP_SCConv(c4, c4, c5),  GhostConv(c4,c4,3,1))
        self.cv4 = Conv(c3 + (2 * c4), c2, 1, 1)
