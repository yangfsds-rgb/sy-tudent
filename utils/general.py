...
def check_suffix(file='C:/Users/86150/Desktop/yolov9-main1/yolov9-main/pt/yolov9s', suffix=('.pt',), msg=''):
...
def increment_path(path, exist_ok=False, sep='', mkdir=False):
    # Increment file or directory path, i.e. runs/yolov9s2 --> runs/yolov9s2{sep}2, runs/yolov9s2{sep}3, ... etc.
