...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default='/home/yanjiusheng03/pengyang/yolov9-main/data/african-wildlife.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', nargs='+', type=str, default='/home/yanjiusheng03/pengyang/yolov9-main/runs/train/exp11/weights/best.pt', help='model.pt path(s)')
